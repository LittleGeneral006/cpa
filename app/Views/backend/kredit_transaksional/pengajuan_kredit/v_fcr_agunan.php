                                    ...
                                    ' </div>'+
                                        ...
                                        '<div class="row">'+
                                            '<div class="col-lg-6">'+
                                                ...
                                                '<div class="col-lg-12">'+
                                                    '<input id="lantai1'+hb+'" name="lantai1[]" value="' + response.luas_bangunan_lantai1[hb] + '" type="number" placeholder="" class="form-control class-readonly lantai1" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                            ...
                                            '<div class="col-lg-6">'+
                                                ...
                                                '<div class="col-lg-12">'+
                                                    '<input id="lantai2'+hb+'" name="lantai2[]" value="' + response.luas_bangunan_lantai2[hb] + '" type="number" placeholder="" class="form-control class-readonly lantai2" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                        ...
                                        '<div class="row">'+
                                            ' <div class="col-lg-6">'+
                                                '<label class="col-lg-12 control-label">Keterangan Lain</label>'+
                                                '<div class="col-lg-12">'+
                                                    '<input id="keterangan_lain_fag'+hb+'" name="keterangan_lain_fag[]" value="' + response.keterangan_lain_bangunan[hb] + '" type="text" placeholder="" class="form-control class-readonly keterangan_lain_fag" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                        ...
                        '<h2 class="text-center text-danger">Bangunan</h2>'+
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">IMB</label>'+
                                       ' <div class="col-lg-12">'+
                                            '<input id="imb'+hitung_bangunan+'" name="imb[]" type="text" placeholder="" class="form-control class-readonly imb" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Pondasi</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="pondasi'+hitung_bangunan+'" name="pondasi[]" type="text" placeholder="" class="form-control class-readonly pondasi" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                   ...
                                   ' <div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Lantai</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="lantai'+hitung_bangunan+'" name="lantai[]" type="text" placeholder="" class="form-control class-readonly lantai" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                   ...
                                   ' <div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Tinggi Lantai Terhadap Jalan</label>'+
                                      '  <div class="col-lg-12">'+
                                           ' <input id="tinggi_lantai_terhadap_jalan'+hitung_bangunan+'" name="tinggi_lantai_terhadap_jalan[]" type="number" placeholder="" class="form-control class-readonly tinggi_lantai_terhadap_jalan" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Rangka</label>'+
                                        '<div class="col-lg-12">'+
                                           ' <input id="rangka'+hitung_bangunan+'" name="rangka[]" type="text" placeholder="" class="form-control class-readonly rangka">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Dinding</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="dinding'+hitung_bangunan+'" name="dinding[]" type="text" placeholder="" class="form-control class-readonly dinding" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                               ...
                               ' </div>'+
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Langit - Langit Plafond</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="langit_plafond'+hitung_bangunan+'" name="langit_plafond[]" type="text" placeholder="" class="form-control class-readonly langit_plafond" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Atap</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="atap'+hitung_bangunan+'" name="atap[]" type="text" placeholder="" class="form-control class-readonly atap" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Tahun Pembangunan</label>'+
                                        '<div class="col-lg-12">'+
                                        '<input id="tahun_pembangunan'+hitung_bangunan+'" name="tahun_pembangunan[]" type="number" placeholder="" class="form-control class-readonly tahun_pembangunan" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Rehab/ Perbaikan</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="rehap_perbaikan'+hitung_bangunan+'" name="rehap_perbaikan[]" type="text" placeholder="" class="form-control class-readonly rehap_perbaikan" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                               ...
                               ' <div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Air</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="air'+hitung_bangunan+'" name="air[]" type="text" placeholder="" class="form-control class-readonly air" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                  ...
                                  '  </div>'+
                                    '<div class="col-lg-6">'+
                                       ' <label class="col-lg-12 control-label">Telepon</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="telepon'+hitung_bangunan+'" name="telepon[]" type="text" placeholder="" class="form-control class-readonly telepon" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                               ...
                               ' </div>'+
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6">'+
                                       ' <label class="col-lg-12 control-label">Listrik</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="listrik'+hitung_bangunan+'" name="listrik[]" type="text" placeholder="" class="form-control class-readonly listrik" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Pagar</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="pagar'+hitung_bangunan+'" name="pagar[]" type="text" placeholder="" class="form-control class-readonly pagar" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                   ' <div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Taman</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="taman'+hitung_bangunan+'" name="taman[]" type="text" placeholder="" class="form-control class-readonly taman" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Lainnya</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="lainnya_fag'+hitung_bangunan+'" name="lainnya_fag[]" type="text" placeholder="" class="form-control class-readonly lainnya_fag" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Luas Bangunan Lantai 1 (M2)</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="lantai1'+hitung_bangunan+'" name="lantai1[]" type="number" placeholder="" class="form-control class-readonly lantai1" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                    ...
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Luas Bangunan Lantai 2 (M2)</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="lantai2'+hitung_bangunan+'" name="lantai2[]" type="number" placeholder="" class="form-control class-readonly lantai2" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Total Bangunan (M2)</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="total_bangunan'+hitung_bangunan+'" name="total_bangunan[]" type="number" placeholder="" class="form-control class-readonly total_bangunan" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                  ...
                                  '  </div>'+
                                   ' <div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Kondisi Bangunan</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="kondisi_bangunan'+hitung_bangunan+'" name="kondisi_bangunan[]" type="text" placeholder="" class="form-control class-readonly kondisi_bangunan" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Sarana yang tersedia disekitar lingkungan</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="sarana'+hitung_bangunan+'" name="sarana[]" type="text" placeholder="" class="form-control class-readonly sarana" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                   ...
                                   ' </div>'+
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Sarana dan prasarana perhubung</label>'+
                                       ' <div class="col-lg-12">'+
                                            '<input id="sarana_prasarana_fag'+hitung_bangunan+'" name="sarana_prasarana_fag[]" type="text" placeholder="" class="form-control class-readonly sarana_prasarana_fag" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                ...
                                '<div class="row">'+
                                    '<div class="col-lg-6">'+
                                        '<label class="col-lg-12 control-label">Kelas dan Lebar Jalan</label>'+
                                        '<div class="col-lg-12">'+
                                            '<input id="kelas'+hitung_bangunan+'" name="kelas[]" type="number" placeholder="" class="form-control class-readonly kelas" <?php echo !empty($edit_data) ? '' : 'readonly'; ?>>'+
                                            '<br>' +
                                    ...
                                    '<div class="col-lg-6">'+
                                        ...
                                        '<div class="row px-3">'+
                                            '<div class="col-lg-6">'+
                                                '<input id="lihat_gambar'+hitung_bangunan+'" value="Lihat Dokumen" name="lihat_gambar[]" data-id="' + hitung_bangunan + '" type="button" placeholder="" class="form-control class-readonly lihat_gambar" onclick="lihatGambar(' + hitung_bangunan + ')">'+

                                            '</div>'+
                                            '<div class="col-lg-6">'+
                                                '<input id="edit_gambar'+hitung_bangunan+'" value="Edit Dokumen" name="edit_gambar[]" type="button" placeholder="" class="form-control class-readonly edit_gambar" onclick="editGambar(' + hitung_bangunan + ')">'+
                                                // '<input id="edit_gambar'+hitung_bangunan+'" name="edit_gambar[]" type="file" placeholder="" class="form-control class-readonly edit_gambar" multiple onclick="editGambar(' + hitung_bangunan + ')">'+
                                                ...
                                                '<form id="form_gambar_edit'+hitung_bangunan+'" class="form-horizontal" enctype="multipart/form-data">'+
                                                    '<div class="modal-body">'+
                                                       ...
                                                       ' <br>'+
                                                        ...
                                                        '<div class="form-group row">'+
                                                            '<input id="kd_data_edit2'+hitung_bangunan+'" name="kd_data_edit2'+hitung_bangunan+'" type="hidden" placeholder="" class="form-control class-readonly">'+
