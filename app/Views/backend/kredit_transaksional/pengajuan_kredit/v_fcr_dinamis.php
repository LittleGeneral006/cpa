...
<fieldset>
    ...
    <button type="button" class="btn btn-primary btn-tambah-fcr" id="btn-tambah-fcr" <?php echo !empty($edit_data) ? '' : 'disabled'; ?>><i class="fa fa-plus"></i> Tambah Data</button>

    <div class="add-form-fcr">
    ...
    <div class="copy-fcr invisible">
        <div class="new" id="new">
            <!-- <div class="form-group row"> -->
                <div class="col-md-12">
                    <div class="input-group">
                        <div class="input-group-append">
                            <button name="hapus_fcr" class="btn btn-danger hapus_fcr delete-btn-fcr" type="button" <?php echo !empty($edit_data) ? '' : 'disabled'; ?>><i class="fa fa-trash-o"></i>&nbsp;Hapus</button>
                        </div>
                    </div>
                </div>
            <!-- </div> -->
...
<script>
    $(document).ready(function() {
        ...
        var counter = 0;
        var jumlahisifcr = 1;
        $("body").on("click", ".btn-tambah-fcr", function() {
            if (jumlahisifcr == 13) {
                swal({
                    title: "Peringatan!",
                ...
                $(".add-form-fcr").after("<hr class='new mt-0 pt-0'>");
                var html1 = $(".copy-fcr").html();
                $(".add-form-fcr").after(html1);
                var html11 =
                    '<div class="form-group">' +
                    '<div class="row">' +
                    '<div class="col-lg-6">' +
                    ...
                    '</div>' +
                    '</div>';
                $(".delete-btn-fcr").first().after(html11);
        ...
        $("body").on("click", ".hapus_fcr", function() {
