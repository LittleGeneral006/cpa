...
<fieldset>
    ...
    <div class="add-form-mauk">
        <div class="form-group row">
            ...
            <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Jenis Kredit</label>
                <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Max. Kredit Saat Ini</label>
                <div class="col-lg-12">
            ...
            <div class="col-lg-2">
                    <label class="col-lg-12 control-label">Perubahan</label>
                <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Max. Kredit Diusulkan</label>
                <div class="col-lg-12">
    ...
    <div class="form-group row">
        <div class="add-form-mauk3">
            <div class="form-group row">
                ...
                <div class="col-lg-2">
                    <label class="col-lg-12 control-label">Agunan</label>
                    <div class="col-lg-12">
                ...
                <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Macam/Jenis</label>
                    <div class="col-lg-12">
                ...
                <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Nilai Agunan</label>
                    <div class="col-lg-12">
                ...
                <div class="col-lg-3">
                    <label class="col-lg-12 control-label">Bentuk Pengikatan</label>
                    <div class="col-lg-12">
