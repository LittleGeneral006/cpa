...
<div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <input id="koor_pemasar" name="koor_pemasar" type="text" placeholder="" class="form-control class-readonly">
            </div>
        </div>
        <div class="col-lg-6">
            <label class="col-lg-12 control-label">Kepala Cabang</label>
            <div class="col-lg-12">
                <input id="kacab" name="kacab" type="text" placeholder="" class="form-control class-readonly">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <input id="kabag" name="kabag" type="text" placeholder="" class="form-control class-readonly">
            </div>
        </div>
        <div class="col-lg-6">
            <label class="col-lg-12 control-label">Kepala Divisi</label>
            <div class="col-lg-12">
                <input id="kadiv" name="kadiv" type="text" placeholder="" class="form-control class-readonly">
            </div>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <input id="npwp" name="npwp" type="text" placeholder="" class="form-control class-readonly">
        </div>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <textarea class="form-control" id="alamat_pemberi_kerja" name="alamat_pemberi_kerja" rows="3"></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <input id="nomor_pk" name="nomor_pk" type="text" placeholder="" class="form-control class-readonly">
        </div>
    </div>
    <div class="col-lg-6">
        <label class="col-lg-12 control-label">Tanggal PK</label>
        <div class="col-lg-12">
            <input id="tanggal_pk" name="tanggal_pk" type="date" placeholder="" class="form-control class-readonly">
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <input id="jangka_waktu_kredit" name="jangka_waktu_kredit" type="text" placeholder="" class="form-control class-readonly">
        </div>
    </div>
</div>
</fieldset>